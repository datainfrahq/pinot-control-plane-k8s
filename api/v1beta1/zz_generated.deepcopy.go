...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8sConfigGroups) DeepCopyInto(out *K8sConfigGroups) {
	*out = *in
	if in.Volumes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8sConfigGroups.
func (in *K8sConfigGroups) DeepCopy() *K8sConfigGroups {
	if in == nil {
		return nil
	}
	out := new(K8sConfigGroups)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PinotNodeConfigGroups) DeepCopyInto(out *PinotNodeConfigGroups) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PinotNodeConfigGroups.
func (in *PinotNodeConfigGroups) DeepCopy() *PinotNodeConfigGroups {
	if in == nil {
		return nil
	}
	out := new(PinotNodeConfigGroups)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PinotSpec) DeepCopyInto(out *PinotSpec) {
	*out = *in
	...
	if in.K8sConfigGroups != nil {
		in, out := &in.K8sConfigGroups, &out.K8sConfigGroups
		*out = make([]K8sConfigGroups, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PinotNodeConfigGroups != nil {
		in, out := &in.PinotNodeConfigGroups, &out.PinotNodeConfigGroups
		*out = make([]PinotNodeConfigGroups, len(*in))
		copy(*out, *in)
	}
	if in.Nodes != nil {
