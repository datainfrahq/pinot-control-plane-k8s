...
func (in *PinotTableStatus) DeepCopyInto(out *PinotTableStatus) {
	*out = *in
	in.LastUpdateTime.DeepCopyInto(&out.LastUpdateTime)
	if in.ReloadStatus != nil {
		in, out := &in.ReloadStatus, &out.ReloadStatus
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
